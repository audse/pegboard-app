...
<form>
    ...
    <color-expandable v-model="main" name="main" label="Main Color" />
    ...
    <expandable :to-show="showAdvanced">
        ...
        <color-expandable v-model="second" name="second" label="Second Color" />
        <color-expandable v-model="text" name="second" label="Text Color" />
    ...
    <co-button type="submit" @click.prevent="addTheme({ name, main, second, text, scale_secondary, scale_text, emphasis, alert, danger })" class="mt-2">
        Add Theme
    </co-button>
</form>
